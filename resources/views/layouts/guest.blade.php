...
<body class="bg-light-gray font-raleway" x-data>
    ...
    <div class="text-gray-900 antialiased">
        ...
        <div x-data="{ open: false }" class="sticky z-10 top-0">
            <!-- Icon -->
            <div class="lg:hidden h-28 pt-2 bg-light-gray flex justify-center">
    ...
    <footer>
        <div class="bg-gradient-to-br from-light-gray to-neutral-300 flex flex-col md:flex-row justify-around gap-8 p-[3.3rem]">
            <div>
