...
<body class="bg-light-gray font-raleway" x-data>
    ...
    <div class="text-gray-900 antialiased">
        ...
        <div x-data="{ open: false }" class="sticky z-10 top-0">
            <!-- Icon -->
            <div class="lg:hidden h-20 bg-light-gray flex justify-end items-center pr-12">
                <svg @click="open = true" class="hover:cursor-pointer" width="50px" height="50px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
